  ...
  return (
    <div id='ourfounder' className='w-full bg-gray-200 py-20 px-4'>
        <div className='max-w-[1024px] mx-auto drop-shadow-2xl'>
            <figure class="md:flex bg-slate-100 rounded-xl p-8 md:p-0 dark:bg-slate-100">
                <img class="w-[330px] h-[330px] md:w-[550px] md:h-[611px] md:rounded-md rounded-full mx-auto" src={MrOni} alt="" width="384" height="512" />
