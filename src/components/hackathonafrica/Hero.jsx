...
export default function Hero() {
  return (
    <div id='hero' className='text-white'>
        <div style={{backgroundImage : `url('/IMG-20221.jpg')`}}  className='bg-cover bg-blend-overlay bg-black/50 bg-top max-w-[100%] mt-[-50px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
            ...
            <p className='text-[#fff] font-bold p-2'>...Creating opportunities for young people to thrive</p>
              <button className='bg-white text-black rounded-md font-medium w-[300px] mx-auto my-6 px-6 py-3'>
                  <Link smooth={true} to='/hackathonafrica#students' className='px-20 py-3'>
                    Testimonials
                  </Link>
              </button>    
        </div>
