  ...
  return (
    <div id='founderhead' className='w-full bg-gray-200 py-20 px-4'>
        ...
        <div className='flex flex-col justify-center'>
                <h2 className='md:text-5xl sm:text-4xl text-3xl font-bold mb-5 py-2 text-justify'>Note From Our Founder</h2>
                <p className='text-justify sm:mb-8 font-medium mb-5 text-2xl'>
                ...
                <p className='text-justify sm:mb-8 font-bold text-2xl'>
